...
function setStarter(root, projectName) {
    ...
    execSync(`mv ${root}/ios/${projectName}/Images.xcassets/AppIcon.appiconset`, { stdio: 'inherit'});
    execSync(`mv ${root}/package/ios/AppIcon.appiconset ${root}/ios/${projectName}/Images.xcassets/`, { stdio: 'inherit'});
    execSync(`mv ${root}/ios/${projectName}/Images.xcassets/LaunchImage.launchimage`, { stdio: 'inherit'});
